...
import edu.carroll.racetrack.service.AdminService;
...
public class AdminApiController {
     ...
     */
    @PostMapping("/users")
    public CreatedUserResponse createUser(@Valid @RequestBody CreateUserRequest request,
     ...
     *
     * @param userId target athlete id
     * @param request athlete update payload
     * @param oidcUser authenticated coach
     * @return updated athlete summary
     */
    @PutMapping("/users/{userId}")
    public CreatedUserResponse updateUser(@PathVariable Long userId,
