...
public class RunningLogService {
     ...
     */
    public List<RunningLog> findByUserId(Long userId) {
        List<RunningLog> logs = runningLogRepository.findByUserIdOrderByLogDateDesc(userId);
     ...
     * @return saved running log
     */
    public RunningLog updateAthleteOwnedLog(Long userId,
                                            Long logId,
                                            Double mileage,
                                            Boolean hurting,
                                            String painDetails,
                                            ...
                                            String details,
                                            LocalDate logDate) {
        RunningLog runningLog = runningLogRepository.findByIdAndUserId(logId, userId)
     ...
     * @param logId running log id
     */
    public void deleteAthleteOwnedLog(Long userId, Long logId) {
        RunningLog runningLog = runningLogRepository.findByIdAndUserId(logId, userId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Running log not found."));
