...
public class AdminService {
     ...
     *
     * @param userId athlete user id / Okta id
    ...
    public void deleteUser(Long userId) {
        ...
        workoutLogRepository.deleteByUserId(normalizedUserId);
        runningLogRepository.deleteByUserId(normalizedUserId);
     ...
     */
    private void ensureEmailAvailableForOtherUser(String email, Long userId) {
    ...
    /**
     * Validates that a user id was provided for update and delete operations.
     *
