...
public class WorkoutLogService {
    ...
    public List<WorkoutLog> findByUserId(Long userId) {
        List<WorkoutLog> logs = workoutLogRepository.findByUserIdOrderByLogDateDesc(userId);
     ...
     * @return saved workout log
     */
    public WorkoutLog updateAthleteOwnedLog(Long userId,
                                            Long logId,
                                            String workoutType,
                                            String completionDetails,
                                             ...
                                             LocalDate logDate) {
        WorkoutLog workoutLog = workoutLogRepository.findByIdAndUserId(logId, userId)
